...
<body onload="MostrarMensaje()">
        ...
        <div class="container">
            ...
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-list-ul me-2"></i>Listado de Modelos</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tblModelos" class="table table-modern table-hover">
                        <thead>
                            <tr>
                                <th>NOMBRE MODELO</th>
                                <th>ACCIONES</th>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function renderizarTabla(datos) {
            var tbody = document.getElementById('tbodyModelos');
            var sb = '';
            if (datos.length === 0) {
            ...
            for (var i = 0; i < datos.length; i++) {
                ...
                sb += '<a href="Modelo.aspx?Operacion=M&IDMod=' + htmlEncode(row.ID) + '" class="btn btn-primary btn-sm btn-accion me-1">Editar</a>';
                sb += '<a href="Modelo.aspx?Operacion=E&IDMod=' + htmlEncode(row.ID) + '" class="btn btn-danger btn-sm btn-accion" onclick="return confirm(\'¿Esta seguro de eliminar este modelo?\');">Eliminar</a>';
                sb += '</td>';
                sb += '</tr>';
            }
            tbody.innerHTML = sb;
