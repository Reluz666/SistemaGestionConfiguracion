        ...
        <div class="container">
            ...
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-list-ul me-2"></i>Listado de Dependencias</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tblDependencias" class="table table-modern table-hover">
                        <thead>
                            <tr>
                                <th>C&Oacute;DIGO</th>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function filtrarTabla(texto) {
            ...
            for (var i = 0; i < datosCompletos.length; i++) {
                ...
                var textoFila = (row.CODIGO || '') + ' ' + (row.NOMBRE || '');
        ...
        function renderizarTabla(datos) {
            var tbody = document.getElementById('tbodyDependencias');
            var sb = '';
            if (datos.length === 0) {
            ...
            for (var i = 0; i < datos.length; i++) {
                ...
                sb += '<a href="Dependencia.aspx?Operacion=M&IdDependencia=' + htmlEncode(row.ID) + '" class="btn btn-primary btn-sm btn-accion me-1">Editar</a>';
                sb += '<a href="Dependencia.aspx?Operacion=E&IdDependencia=' + htmlEncode(row.ID) + '" class="btn btn-danger btn-sm btn-accion" onclick="return confirm(\'¿Esta seguro de eliminar esta dependencia?\');">Eliminar</a>';
                sb += '</td>';
                sb += '</tr>';
            }
            tbody.innerHTML = sb;
