    ...
    <div class ="container">
         <div class="table-responsive" >
             <table class="table text-center" >
                <thead>                       
                  <tr>
                    <td style="text-align: center; color: #FFFFFF; background-color: #000000;" colspan="3"> INGRESE DATOS DEPENDENCIA</td>
                   
                  </tr>
                  <tr>
                        <td style="text-align: left; color: #FFFFFF; background-color: #000000;" 
                            class="style2" colspan="3"> Codigo Dependencia</td>
                  ...
                  <tr>
                        <td style="text-align: left; color: #FFFFFF; background-color: #FFFFFF;" 
                            class="style2" colspan="3">  
                             <asp:TextBox ID="Codigo_Depemdencia" runat="server" CssClass="form-control input-sm" MaxLength="4" Autocomplete = "off" placeholder="Ingrese Codigo Dependencia" onchange="" 
                        onkeypress="SoloNumeros()"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="rfvCodigo_Depemdencia" runat="server" ControlToValidate="Codigo_Depemdencia" ErrorMessage="*" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                  ...
                  <tr>
                        <td style="text-align: left; color: #FFFFFF; background-color: #000000;" 
                            class="style2" colspan="3"> Nombre Dependencia</td>
                  ...
                  <tr>
                        <td style="text-align: left;" 
                            class="style2" colspan="3"> 
                             <asp:TextBox ID="Nombre_Dependencia" runat="server" CssClass="form-control input-sm" MaxLength="999" Autocomplete = "off" placeholder="Ingrese Nombre Dependencia" onchange="CambiaLetraMayuscula('Nombre_Dependencia')" 
                        onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="rfvNombre_Dependencia" runat="server" ControlToValidate="Nombre_Dependencia" ErrorMessage="*" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                ...
                <td colspan="3" style="text-align: center">
                   <asp:Button ID="btnRegistrar" runat="server" 
                    ...
                    <asp:Button ID="btnModificar" runat="server" 
                        style="font-family: Calibri; color: #000000; font-size: medium" 
                        Text="Modificar"  onclientclick="return Confirmar('¿Desea modificar dependencia?');" CssClass="btn btn-warning" Visible="False" OnClick="btnModificar_Click" />
                    &nbsp;
                    <asp:Button ID="btnEliminar" runat="server" 
                        style="font-family: Calibri; color: #000000; font-size: medium" 
                        Text="Eliminar"  onclientclick="return Confirmar('¿Desea eliminar dependencia?');" class="btn btn-danger" Visible="False" OnClick="btnEliminar_Click" />
                    &nbsp;
    ...
    <div class ="container">
        ...
        <tr>
            <td colspan="3">
                    ...
                    <asp:HiddenField ID="Id_Dependencia" runat="server" Value="0" 
