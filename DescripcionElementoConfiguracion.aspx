        ...
        <div class="container">
                ...
                <div class="card-body p-3">
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <asp:TextBox ID="NOMBRE_DESCRIPCION" runat="server" CssClass="form-control form-control-modern"
                                         MaxLength="25" Autocomplete="off" placeholder="Ingrese Nombre Descripcion Elemento Configuracion"
                                         onchange="CambiaLetraMayuscula('NOMBRE_DESCRIPCION')"
                                         onkeypress="SoloLetrasMinusculas()" />
                            <asp:RequiredFieldValidator ID="rfvNOMBRE_DESCRIPCION" runat="server" ControlToValidate="NOMBRE_DESCRIPCION"
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        <asp:Button ID="btnRegistrar" runat="server" Text="Registrar" CssClass="btn btn-success btn-modern"
                                    OnClientClick="return Confirmar('¿Desea registrar Descripcion Elemento Configuracion?');"
                                    OnClick="btnRegistrar_Click" />
                        <asp:Button ID="btnModificar" runat="server" Text="Modificar" CssClass="btn btn-warning btn-modern"
                                    OnClientClick="return Confirmar('¿Desea modificar Descripcion Elemento Configuracion?');"
                                    OnClick="btnModificar_Click" />
                        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn btn-danger btn-modern"
                                    OnClientClick="return Confirmar('¿Desea eliminar Descripcion Elemento Configuracion?');"
            ...
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-list-ul me-2"></i>Listado de Descripciones de Elementos de Configuracion</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tblDescripciones" class="table table-modern table-hover">
                        <thead>
                            <tr>
                                <th>TIPO CI</th>
            ...
            <asp:HiddenField ID="ID_DESCRIPCION" runat="server" Value="0" EnableViewState="False" />
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function filtrarTabla(texto) {
            ...
            for (var i = 0; i < datosCompletos.length; i++) {
                ...
                var textoFila = (row.TIPO_CI || '') + ' ' + (row.NOMBRE || '');
        ...
        function renderizarTabla(datos) {
            var tbody = document.getElementById('tbodyDescripciones');
            var sb = '';
            if (datos.length === 0) {
            ...
            for (var i = 0; i < datos.length; i++) {
                ...
                sb += '<a href="DescripcionElementoConfiguracion.aspx?Operacion=M&IDDesc=' + htmlEncode(row.ID) + '" class="btn btn-primary btn-sm btn-accion me-1">Editar</a>';
                sb += '<a href="DescripcionElementoConfiguracion.aspx?Operacion=E&IDDesc=' + htmlEncode(row.ID) + '" class="btn btn-danger btn-sm btn-accion" onclick="return confirm(\'¿Esta seguro de eliminar esta descripcion?\');">Eliminar</a>';
                sb += '</td>';
                sb += '</tr>';
            }
            tbody.innerHTML = sb;
