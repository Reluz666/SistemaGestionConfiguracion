<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DescripcionElementoConfiguracion.aspx.cs" Inherits="DescripcionElementoConfiguracion"  UnobtrusiveValidationMode="None" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Descripcion Elemento Configuracion</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>    
    <meta charset="utf-8"/>    
    ...
    <div class ="container">
         <div class="table-responsive" >
             <table class="table text-center" >
                <thead>                       
                  <tr>
                    <td style="text-align: center; color: #FFFFFF; background-color: #000000;" colspan="3"> INGRESE DATOS DESCRIPCION ELEMENTO CONFIGURACION</td>
                   
                  </tr>
                  <tr>
                        <td style="text-align: left; color: #FFFFFF; background-color: #000000;" 
                            class="style2" colspan="3"> Tipo CI</td>
                  ...
                  <tr>
                        <td style="text-align: left; color: #FFFFFF; background-color: #000000;" 
                            class="style2" colspan="3"> Nombre Descripcion CI</td>
                  ...
                  <tr>
                        <td style="text-align: left;" 
                            class="style2" colspan="3"> 
                             <asp:TextBox ID="NOMBRE_DESCRIPCION" runat="server" CssClass="form-control input-sm" Autocomplete = "off" placeholder="Ingrese Nombre Descripcion Elemento Configuracion" onchange="CambiaLetraMayuscula('NOMBRE_DESCRIPCION')" 
                        onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="rfvNOMBRE_DESCRIPCION" runat="server" ControlToValidate="NOMBRE_DESCRIPCION" ErrorMessage="*" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                ...
                <td colspan="3" style="text-align: center">
                   <asp:Button ID="btnRegistrar" runat="server" 
                       style="font-family: Calibri; color: #000000; font-size: medium" 
                        Text="Registrar" 
                        onclientclick="return Confirmar('¿Desea registrar Descripcion Relacion Elemento Configuracion?');" 
                        CssClass="btn btn-success" Visible="False" OnClick="btnRegistrar_Click" />
                    &nbsp;
                    <asp:Button ID="btnModificar" runat="server" 
                        style="font-family: Calibri; color: #000000; font-size: medium" 
                        Text="Modificar"  onclientclick="return Confirmar('¿Desea modificar Descripcion Relacion Elemento Configuracion?');" CssClass="btn btn-warning" Visible="False" OnClick="btnModificar_Click" />
                    &nbsp;
                    <asp:Button ID="btnEliminar" runat="server" 
                        style="font-family: Calibri; color: #000000; font-size: medium" 
                        Text="Eliminar"  onclientclick="return Confirmar('¿Desea eliminar Descripcion Relacion Elemento Configuracion?');" class="btn btn-danger" Visible="False" OnClick="btnEliminar_Click" />
                    &nbsp;
    ...
    <div class ="container">
            ...
            <td colspan="4">
                        ...
                        <asp:Table ID="Table_" runat="server" CssClass="form-control input" 
                            ...
                            <asp:TableRow ID="TableRow1" runat="server">
                                <asp:TableCell ID="tcID_DESCRIPCION"  runat="server" BackColor="Black" BorderColor="Black" 
                                 ...
                                 <asp:TableCell ID="tcTIPO_CI"  runat="server" BackColor="Black" BorderColor="Black" 
                                    ForeColor="White"  Width="15%">TIPO CI</asp:TableCell>  

                                <asp:TableCell ID="tcNOMBRE_DESCRIPCION"  runat="server" BackColor="Black" BorderColor="Black" 
                                    ForeColor="White"  Width="15%">DESCRIPCION CI</asp:TableCell>                               

                                <asp:TableCell ID="SELECCIONAR_TIPO_RELACION_CI" runat="server" BackColor="Black" BorderColor="Black" 
                                    ForeColor="White" Width="7%">SELECCIONAR DESCRIPCION CI</asp:TableCell>
        ...
        <tr>
            <td colspan="3">
                    ...
                    <asp:HiddenField ID="ID_DESCRIPCION" runat="server" Value="0" 
