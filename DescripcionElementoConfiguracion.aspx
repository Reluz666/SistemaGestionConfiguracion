        ...
        <div class="container">
            ...
            <div class="form-card">
                <div class="card-header">
                    <i class="bi bi-list-ul me-2"></i>Ingrese Datos Descripcion Elemento Configuracion
                </div>
                <div class="card-body p-3">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <label class="form-label-modern">Nombre Descripcion CI</label>
                            <asp:TextBox ID="NOMBRE_DESCRIPCION" runat="server" CssClass="form-control form-control-modern" Autocomplete="off" placeholder="Ingrese Nombre Descripcion Elemento Configuracion" onchange="CambiaLetraMayuscula('NOMBRE_DESCRIPCION')"
                        onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvNOMBRE_DESCRIPCION" runat="server" ControlToValidate="NOMBRE_DESCRIPCION" ErrorMessage="*" CssClass="validator-error" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        ...
                        <asp:Button ID="btnModificar" runat="server"
                            style="font-family: Calibri; color: #000000; font-size: medium"
                            Text="Modificar"  onclientclick="return Confirmar('¿Desea modificar Descripcion Relacion Elemento Configuracion?');" CssClass="btn btn-warning btn-modern" Visible="False" OnClick="btnModificar_Click" />
                        <asp:Button ID="btnEliminar" runat="server"
                            style="font-family: Calibri; color: #000000; font-size: medium"
                            Text="Eliminar"  onclientclick="return Confirmar('¿Desea eliminar Descripcion Relacion Elemento Configuracion?');" class="btn btn-danger btn-modern" Visible="False" OnClick="btnEliminar_Click" />
