        ...
        <div class="container">
                ...
                <div class="card-body p-3">
                    <div class="row g-3 mb-3">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <asp:TextBox ID="NOMBRE_TIPO_COMPONENTE" runat="server" CssClass="form-control form-control-modern"
                                         MaxLength="25" Autocomplete="off" placeholder="Ingrese Nombre Componente CI"
                                         onchange="CambiaLetraMayuscula('NOMBRE_TIPO_COMPONENTE')"
                                         onkeypress="SoloLetrasMinusculas()" />
                            <asp:RequiredFieldValidator ID="rfvNOMBRE_TIPO_COMPONENTE" runat="server" ControlToValidate="NOMBRE_TIPO_COMPONENTE"
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        ...
                        <asp:Button ID="btnModificar" runat="server" Text="Modificar" CssClass="btn btn-warning btn-modern"
                                    OnClientClick="return Confirmar('¿Desea modificar componente CI?');"
                                    OnClick="btnModificar_Click" />
                        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn btn-danger btn-modern"
                                    OnClientClick="return Confirmar('¿Desea eliminar componente CI?');"
            ...
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-list-ul me-2"></i>Listado de Tipos de Componentes</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tblComponentes" class="table table-modern table-hover">
                        <thead>
                            <tr>
            ...
            <asp:HiddenField ID="ID_TIPO_COMPONENTE" runat="server" Value="0" EnableViewState="False" />
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function renderizarTabla(datos) {
            ...
            for (var i = 0; i < datos.length; i++) {
                ...
                sb += '<a href="TipoComponeneteCI.aspx?Operacion=M&IDTipoComp=' + htmlEncode(row.ID) + '" class="btn btn-primary btn-sm btn-accion me-1">Editar</a>';
                sb += '<a href="TipoComponeneteCI.aspx?Operacion=E&IDTipoComp=' + htmlEncode(row.ID) + '" class="btn btn-danger btn-sm btn-accion" onclick="return confirm(\'¿Esta seguro de eliminar este componente?\');">Eliminar</a>';
                sb += '</td>';
                sb += '</tr>';
            }
            tbody.innerHTML = sb;
