<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TipoComponeneteCI.aspx.cs" Inherits="TiposElementoConfiguracion" UnobtrusiveValidationMode="None" %>
...
<head runat="server">
    ...
    <title>Tipo Componente CI</title>
        ...
        <div class="container">
            ...
            <div class="form-card">
                <div class="card-header">
                    <i class="bi bi-list-ul me-2"></i>Ingrese Datos Tipo Componente Elemento Configuracion
                </div>
                <div class="card-body p-3">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-12 col-sm-12">
                            <label class="form-label-modern">Nombre Componente</label>
                            <asp:TextBox ID="NOMBRE_TIPO_COMPONENTE" runat="server" CssClass="form-control form-control-modern" MaxLength="25" Autocomplete="off" placeholder="Ingrese Nombre Componente CI" onchange="CambiaLetraMayuscula('NOMBRE_TIPO_COMPONENTE')"
                        onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvNOMBRE_TIPO_COMPONENTE" runat="server" ControlToValidate="NOMBRE_TIPO_COMPONENTE" ErrorMessage="*" CssClass="validator-error" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        <asp:Button ID="btnRegistrar" runat="server"
                            ...
                            Text="Registrar"
                            onclientclick="return Confirmar('¿Desea registrar componente CI?');"
                            CssClass="btn btn-success btn-modern" Visible="False" OnClick="btnRegistrar_Click" />
                        <asp:Button ID="btnModificar" runat="server"
                            style="font-family: Calibri; color: #000000; font-size: medium"
                            Text="Modificar"  onclientclick="return Confirmar('¿Desea modificar componente CI?');" CssClass="btn btn-warning btn-modern" Visible="False" OnClick="btnModificar_Click" />
                        <asp:Button ID="btnEliminar" runat="server"
                            style="font-family: Calibri; color: #000000; font-size: medium"
                            Text="Eliminar"  onclientclick="return Confirmar('¿Desea eliminar componente CI?');" class="btn btn-danger btn-modern" Visible="False" OnClick="btnEliminar_Click" />
            ...
            <div class="table-wrapper">
                <asp:Table ID="Table_" runat="server" CssClass="table table-modern-grid table-hover">
                    <asp:TableRow ID="TableRow1" runat="server">
                        <asp:TableCell ID="tcID_TIPO_COMPONENTE"  runat="server" BackColor="Black" BorderColor="Black"
                            ForeColor="White" Width="7%" Visible="false">ID</asp:TableCell>

                         <asp:TableCell ID="tcNOMBRE_TIPO_COMPONENTE"  runat="server" BackColor="Black" BorderColor="Black"
                            ForeColor="White"  Width="15%">NOMBRE COMPONENTE</asp:TableCell>

                        <asp:TableCell ID="SELECCIONAR_ESTADO_ACTUAL" runat="server" BackColor="Black" BorderColor="Black"
                            ForeColor="White" Width="7%"><center>SELECCIONAR</center></asp:TableCell>
            ...
            <asp:HiddenField ID="ID_TIPO_COMPONENTE" runat="server" Value="0"
