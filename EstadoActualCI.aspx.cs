...
public partial class TiposElementoConfiguracion : System.Web.UI.Page
{
    ...
    {
        if (Convert.ToInt32(this.ID_ESTADO_ACTUAL.Value.Trim()) == 0)
        {
    ...
    protected void visualiza_datos_estado_actual_cis(object sender, EventArgs e)
    {
        ...
        this.ID_ESTADO_ACTUAL.Value = Datos[0];
        this.NOMBRE_ESTADO_ACTUL.Text = Datos[1];
        ...
        try
        {
            if (servidor.abrirconexiontrans() == true)
            {
                ...
                if (servidor.getRespuesta() == 1)
                {
                    ...
                    ShowMessage(servidor.getMensaje(), "EstadoActualCI.aspx");
                }
                else
                {
    ...
    protected void btnCancelar_Click(object sender, EventArgs e)
    {
        ...
        this.Response.Redirect("EstadoActualCI.aspx");
    }
