<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReporteDatosIncorrectosCI.aspx.cs" Inherits="ReporteDatosIncorrectosCI" UnobtrusiveValidationMode="None" %>
...
<head runat="server">
    ...
    <script lang="javascript" type="text/javascript">
        // Grid configuration for ReporteDatosIncorrectosCI
        ...
        function abrir_ventana_imprimir_reporte() {
            window.name = "ReporteDatosIncorrectos";
        ...
        <div class="container" style="margin-top: 80px;">
            <div class="form-card">
                <div class="card-header">
                    <i class="bi bi-exclamation-triangle me-2"></i>Reporte de CIs con Datos Incorrectos
                </div>
                <div class="card-body p-3">
                    ...
                    <div class="table-wrapper">
                        <table id="tblDatosIncorrectos" class="table table-modern table-hover" style="min-width: 800px;">
                            <thead>
                                <tr>
                                    <th style="width: 150px;">AREA</th>
                                    <th style="width: 150px;">TIPO CI</th>
                                    <th style="width: 180px;">DESCRIPCION CI</th>
