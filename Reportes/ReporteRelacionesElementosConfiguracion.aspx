<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReporteRelacionesElementosConfiguracion.aspx.cs" Inherits="RelacionesElementosConfiguracion" %>
           ...
           <div class="container-fluid">
                <table class="table table text-center">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left" >
                            <asp:CheckBox ID="cbl" runat="server" CssClass="form-check-input position-static" Font-Size="X-Small" Text="Local" AutoPostBack="True" OnCheckedChanged="cbl_CheckedChanged1" />
                        </td>
                        <td style="text-align: left" >
                            <asp:CheckBox ID="cba" runat="server" CssClass="form-check-input position-static" Font-Size="X-Small" Text="Area" OnCheckedChanged="cba_CheckedChanged" CausesValidation="True"/>
                        </td>
                        <td style="text-align: left" >
                            &nbsp;</td>
                        <td class="auto-style1">
                    ...
                    <tr>
                    <td colspan="5">
                        <asp:Label ID="T" runat="server" style="font-weight: 700"></asp:Label>
                        <br />
                        <asp:Label ID="A" runat="server" style="font-weight: 700"></asp:Label>
                        <br />
                        <asp:Label ID="X" runat="server" style="font-weight: 700"></asp:Label>
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
