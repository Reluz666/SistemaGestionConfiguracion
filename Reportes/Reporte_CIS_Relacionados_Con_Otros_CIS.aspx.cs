...
public partial class Reporte_CIS_Relacionados_Con_Otros_CIS : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (servidor.abrirconexion() == true)
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        if (!string.IsNullOrEmpty(dt.Rows[i]["PADRE CI"].ToString()))
                        {
                            A++;
                        }
                    }
                    ...
                    // Update stats labels
                    this.T.Text = "Nro. Total de CIs registrados que pueden estar relacionados con otros elementos de configuración: " + T.ToString();
                    this.A.Text = "Nro. de CIs relacionado a uno u otros elementos de configuración : " + A.ToString();
