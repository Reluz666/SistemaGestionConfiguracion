...
<head runat="server">
    ...
    <style>
        /* Estilos especificos para este reporte */
    ...
    <script lang="javascript" type="text/javascript">
        // Grid configuration for Reporte Datos Correctos CI
        var datosCorrectosGridConfig = {
            tableId: 'tblDatosCorrectos',
            tbodyId: 'tbodyDatosCorrectos',
            searchInputId: 'txtBuscar',
            paginationWrapperId: 'paginationDatosCorrectos',
            pageInfoId: 'pageInfoDatosCorrectos',
            ...
            columnRenderer: function(item) {
                var isSummary = item.IS_SUMMARY === 'true';
                if (isSummary) {
                    var colorClass = item.SUMMARY_COLOR || '';
                    return '<tr class="summary-row ' + colorClass + '">' +
        ...
        function initDatosCorrectosGrid() {
        ...
        function abrir_ventana_imprimir_reporte(Opcion) {
            if (Verificar_Datos_tabla(Opcion)) {
                window.name = "Reporte Datos Correctos CI";
        ...
        function Verificar_Datos_tabla(Opcion) {
            ...
            var gridState = GridUtils.getState('tblDatosCorrectos');
...
<body onload="MostrarMensaje()">
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="form-card">
                <div class="card-header">
                    <i class="bi bi-check-circle me-2"></i>Lista de CIs con Datos Registrados Correctamente
                </div>
                <div class="card-body p-3">
                    <!-- Buscador -->
                    <div class="row mb-3">
                    ...
                    <div class="table-wrapper" style="max-height: 500px; overflow-y: auto;">
                        <table id="tblDatosCorrectos" class="table table-modern-grid table-hover" style="min-width: 900px;">
                            <thead>
                                <tr>
                                    <th>AREA</th>
                                    <th>TIPO CI</th>
                    ...
                    <div class="pagination-wrapper">
                        <ul id="paginationDatosCorrectos" class="pagination" style="flex-wrap: wrap;"></ul>
                    </div>
                    <div class="page-info" id="pageInfoDatosCorrectos"></div>
                </div>
            </div>
