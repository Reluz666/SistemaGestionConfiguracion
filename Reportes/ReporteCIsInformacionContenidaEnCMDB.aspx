        ...
        <div class="container">
            <div class="table-responsive">
               <div class="table-wrapper">
                    <table class="table table text-center">
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                ...
                                <asp:Button ID="btnActualizarInformacion" runat="server" class="btn btn-success btn-modern" onclick="btnActualizarInformacion_Click" Text="Mostrar Todos los CIs" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center" colspan="5" >
                                <strong>Lista de Elementos de Configuracion</strong></td>
                        </tr>
                        <tr>
                        <td colspan="5">
                        ...
                        <tr>
                        <td colspan="5">
                            <strong>Lista de Licencias</strong></td>
                    <td>
                        &nbsp;</td>
                </tr>
                        <tr>
                ...
                <tr>
                    <td colspan="5" >
                        <asp:Label ID="Label3" runat="server" Text="% de CIs cuya informacion estan contenidas en la CMDB"></asp:Label>
                    </td>
                    <td >
                        &nbsp;</td>
                </tr>
