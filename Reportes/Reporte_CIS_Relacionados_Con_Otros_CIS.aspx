<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reporte_CIS_Relacionados_Con_Otros_CIS.aspx.cs" Inherits="Reporte_CIS_Relacionados_Con_Otros_CIS" UnobtrusiveValidationMode="None" %>
...
<head runat="server">
    ...
    <title>Reporte de CIS Relacionados con Otros CIS</title>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        // Grid configuration for Reporte CIS Relacionados
        var cisRelacionadosGridConfig = {
            tableId: 'tblReporte',
            ...
            onInitialized: function() {
                ...
                var state = GridUtils.getState('tblReporte');
                if (state && state.config.stats) {
                    document.getElementById('lblTotalT').textContent = state.config.stats.T;
                    document.getElementById('lblTotalA').textContent = state.config.stats.A;
                    document.getElementById('lblTotalX').textContent = state.config.stats.X;
                }
            }
        };
    </script>
        ...
        <div class="container">
            <div class="form-card">
                <div class="card-header">
                    <i class="bi bi-diagram-3 me-2"></i>Reporte de CIS Relacionados con Otros CIS
                </div>
