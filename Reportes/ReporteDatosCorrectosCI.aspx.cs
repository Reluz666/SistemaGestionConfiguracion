...
public partial class ReporteDatosCorrectosCI : System.Web.UI.Page
{
    ...
    private void Cargar_Datos_Correctos(string Nombre_CI, string Tipo_CI, string Nro_Serie, string Descripcion_CI, string Sede, string Local, string Area, string Responsable, string Clasificacion_Datos, string Relacion_otros_CIs, string Fecha_Inicio, string Fecha_Fin, string Estado_Actual_CIs, String Mensaje)
    {
        ...
        try
        {
            ...
            {
                DataTable dt = servidor.consultar("[dbo].[pr_ReporteDatosCorrectosCI]", Nombre_CI, Tipo_CI, Nro_Serie, Descripcion_CI, Sede, Local, Area, Responsable, Clasificacion_Datos, Relacion_otros_CIs, Fecha_Inicio, Fecha_Fin, Estado_Actual_CIs).Tables[0];
                ...
                else
                {
                    ...
                    int porcentaje = Cantidad_CIs_CMDB > 0 ? (CantidadCorrectos * 100) / Cantidad_CIs_CMDB : 0;
    ...
    protected void Page_init(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            this.Cargar_Datos_Correctos(ob[0].ToString().Trim(),
            ob[2].ToString().Trim(),
            ob[4].ToString().Trim(),
            ob[6].ToString().Trim(),
            ob[8].ToString().Trim(),
