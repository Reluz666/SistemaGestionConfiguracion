        ...
        <div class="container">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-4 col-sm-6">
                            ...
                            <asp:TextBox ID="Email" runat="server" CssClass="form-control form-control-modern" Autocomplete="off" placeholder="Ingresar Email"></asp:TextBox>
                        ...
                        <div class="col-md-4 col-sm-6">
                            ...
                            <asp:TextBox ID="Login" runat="server" CssClass="form-control form-control-modern" MaxLength="50" Autocomplete="off" placeholder="Ingresar Login"></asp:TextBox>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4 col-sm-6">
                            ...
                            <asp:TextBox ID="Password" runat="server" CssClass="form-control form-control-modern" MaxLength="50" Autocomplete="off" placeholder="Ingresar Password"></asp:TextBox>
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        ...
                        <asp:Button ID="btnModificar" runat="server" Text="Modificar" CssClass="btn btn-warning btn-modern"
                                    OnClientClick="return Confirmar('¿Desea modificar Usuario?');"
                                    OnClick="btnModificar_Click" />
                        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn btn-danger btn-modern"
                                    OnClientClick="return Confirmar('¿Desea eliminar Usuario?');"
            ...
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-list-ul me-2"></i>Listado de Usuarios</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tblUsuarios" class="table table-modern table-hover">
                        <thead>
                            <tr>
                                <th>USUARIO</th>
                                <th>CARGO</th>
            ...
            <asp:HiddenField ID="ID_USUARIO" runat="server" Value="0" EnableViewState="False" />
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function filtrarTabla(texto) {
            ...
            for (var i = 0; i < datosCompletos.length; i++) {
                ...
                var textoFila = (row.NOMBRE || '') + ' ' + (row.CARGO || '') + ' ' + (row.EMAIL || '') + ' ' + (row.LOGIN || '');
        ...
        function renderizarTabla(datos) {
            ...
            for (var i = 0; i < datos.length; i++) {
                var row = datos[i];
                var estadoClass = row.ESTADO === 'INACTIVO' ? 'text-danger' : 'text-primary';
                sb += '<tr>';
                sb += '<td>' + htmlEncode(row.NOMBRE) + '</td>';
                sb += '<td>' + htmlEncode(row.CARGO) + '</td>';
                sb += '<td>' + htmlEncode(row.TELEFONO) + '</td>';
                sb += '<td>' + htmlEncode(row.EMAIL) + '</td>';
                sb += '<td>' + htmlEncode(row.LOGIN) + '</td>';
                sb += '<td class="' + estadoClass + '">' + htmlEncode(row.ESTADO) + '</td>';
                sb += '<td class="text-center">';
                sb += '<a href="Usuario.aspx?Operacion=M&IDUsu=' + htmlEncode(row.ID) + '" class="btn btn-primary btn-sm btn-accion me-1">Editar</a>';
                sb += '<a href="Usuario.aspx?Operacion=E&IDUsu=' + htmlEncode(row.ID) + '" class="btn btn-danger btn-sm btn-accion" onclick="return confirm(\'¿Esta seguro de eliminar este usuario?\');">Eliminar</a>';
                sb += '</td>';
                sb += '</tr>';
            }
            tbody.innerHTML = sb;
