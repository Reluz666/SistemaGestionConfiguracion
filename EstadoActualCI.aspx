...
<head runat="server">
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function window_load() { MostrarMensaje() }
...
<body onload="MostrarMensaje()">
        ...
        <div class="container">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        ...
                        <asp:Button ID="btnModificar" runat="server" Text="Modificar" CssClass="btn btn-warning btn-modern"
                                    OnClientClick="return Confirmar('¿Desea modificar estado actual CI?');"
                                    OnClick="btnModificar_Click" />
                        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn btn-danger btn-modern"
                                    OnClientClick="return Confirmar('¿Desea eliminar estado actual CI?');"
            ...
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-list-ul me-2"></i>Listado de Estados Actuales</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tblEstados" class="table table-modern table-hover">
                        <thead>
                            <tr>
                                <th>NOMBRE ESTADO</th>
                                <th>ACCIONES</th>
            ...
            <asp:HiddenField ID="ID_ESTADO_ACTUAL" runat="server" Value="0" EnableViewState="False" />
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function renderizarTabla(datos) {
            var tbody = document.getElementById('tbodyEstados');
            var sb = '';
            if (datos.length === 0) {
            ...
            for (var i = 0; i < datos.length; i++) {
                ...
                sb += '<a href="EstadoActualCI.aspx?Operacion=M&IDEstadoActual=' + htmlEncode(row.ID) + '" class="btn btn-primary btn-sm btn-accion me-1">Editar</a>';
                sb += '<a href="EstadoActualCI.aspx?Operacion=E&IDEstadoActual=' + htmlEncode(row.ID) + '" class="btn btn-danger btn-sm btn-accion" onclick="return confirm(\'¿Esta seguro de eliminar este estado?\');">Eliminar</a>';
                sb += '</td>';
                sb += '</tr>';
            }
            tbody.innerHTML = sb;
