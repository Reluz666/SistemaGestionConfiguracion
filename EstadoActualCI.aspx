<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EstadoActualCI.aspx.cs" Inherits="TiposElementoConfiguracion" UnobtrusiveValidationMode="None" %>
    ...
    <div class ="container">
         <div class="table-responsive" >
             <table class="table text-center" >
                <thead>                       
                  <tr>
                    <td style="text-align: center; color: #FFFFFF; background-color: #000000;" colspan="3"> INGRESE DATOS ESTADO ACTUAL ELEMENTO CONFIGURACION</td>
                  ...
                  <tr>
                        <td style="text-align: left; color: #FFFFFF; background-color: #000000;" 
                            class="style2" colspan="3"> Nombre Estado</td>
                  ...
                  <tr>
                        <td style="text-align: left;" 
                            class="style2" colspan="3"> 
                             <asp:TextBox ID="NOMBRE_ESTADO_ACTUL" runat="server" CssClass="form-control input-sm" MaxLength="25" Autocomplete = "off" placeholder="Ingrese Nombre Estado Actual CI" onchange="CambiaLetraMayuscula('NOMBRE_ESTADO_ACTUL')" 
                        onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="rfvNOMBRE_ESTADO_ACTUL" runat="server" ControlToValidate="NOMBRE_ESTADO_ACTUL" ErrorMessage="*" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                ...
                <td colspan="3" style="text-align: center">
                   <asp:Button ID="btnRegistrar" runat="server" 
                       style="font-family: Calibri; color: #000000; font-size: medium" 
                        Text="Registrar" 
                        onclientclick="return Confirmar('¿Desea registrar estado actual CI?');" 
                        CssClass="btn btn-success" Visible="False" OnClick="btnRegistrar_Click" />
                    &nbsp;
                    <asp:Button ID="btnModificar" runat="server" 
                        style="font-family: Calibri; color: #000000; font-size: medium" 
                        Text="Modificar"  onclientclick="return Confirmar('¿Desea modificar estado actual CI?');" CssClass="btn btn-warning" Visible="False" OnClick="btnModificar_Click" />
                    &nbsp;
                    <asp:Button ID="btnEliminar" runat="server" 
                        style="font-family: Calibri; color: #000000; font-size: medium" 
                        Text="Eliminar"  onclientclick="return Confirmar('¿Desea eliminar estado actual CI?');" class="btn btn-danger" Visible="False" OnClick="btnEliminar_Click" />
                    &nbsp;
    ...
    <div class ="container">
            ...
            <td colspan="4">
                        ...
                        <asp:Table ID="Table_" runat="server" CssClass="form-control input" 
                            ...
                            <asp:TableRow ID="TableRow1" runat="server">
                                <asp:TableCell ID="tcID_ESTADO_ACTUAL"  runat="server" BackColor="Black" BorderColor="Black" 
                                    ForeColor="White" Width="7%" Visible="false">ID</asp:TableCell>

                                 <asp:TableCell ID="tcNOMBRE_ESTADO_ACTUL"  runat="server" BackColor="Black" BorderColor="Black" 
                                    ForeColor="White"  Width="15%">NOMBRE ESTADO</asp:TableCell>
        ...
        <tr>
            <td colspan="3">
                    ...
                    <asp:HiddenField ID="ID_ESTADO_ACTUAL" runat="server" Value="0" 
