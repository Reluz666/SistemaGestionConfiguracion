...
public partial class TiposElementoConfiguracion : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (servidor.abrirconexion() == true)
            {
                ...
                if (dt.Rows.Count == 0)
                {
                    ...
                    _Lista.ShowMessage(__mensaje, __pagina, "No hay Tipo Componnetes de CI registrados.", "");
                }
                else
                {
    ...
    private void Matenimiento_Tipo_Componente_CI(int ID_TIPO_COMPONENTE,
        string NOMBRE_TIPO_COMPONENTE,
        string operacion)
    {
        policia.clsaccesodatos servidor = new policia.clsaccesodatos();
        servidor.cadenaconexion = Ruta;
        try
        {
            ...
            {
                servidor.ejecutar("[dbo].[pr_MatenimientoTipoComponenteCI]",
                                    false,
                                    ID_TIPO_COMPONENTE,
                                    NOMBRE_TIPO_COMPONENTE.Trim(),                                  
                                    operacion,
                                    0, "");
    ...
    protected void btnRegistrar_Click(object sender, EventArgs e)
    {
        ...
        Boolean ok;
        ok = rfvNOMBRE_TIPO_COMPONENTE.IsValid;
        if (ok == false)
        {
            return;
        }
        ...
        this.Matenimiento_Tipo_Componente_CI(Convert.ToInt32(this.ID_TIPO_COMPONENTE.Value.Trim()),
            ...
            this.NOMBRE_TIPO_COMPONENTE.Text.Trim(),
            "N");
    }
    ...
    protected void btnModificar_Click(object sender, EventArgs e)
    {
        ...
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]),
        "TipoComponeneteCI.aspx", "MODIFICAR");
        if (rpta == false)
        {
    ...
    protected void btnEliminar_Click(object sender, EventArgs e)
    {
        ...
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]),
        "TipoComponeneteCI.aspx", "ELIMINAR");
        if (rpta == false)
        {
    ...
    protected void btnCancelar_Click(object sender, EventArgs e)
    {
        ...
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]),
        "TipoComponeneteCI.aspx", "CANCELAR");
        if (rpta == false)
        {
