<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CIsAsignarComponenetes.aspx.cs" Inherits="ElementosConfiguracion"  UnobtrusiveValidationMode="None" %>
                        ...
                        <td colspan="5">
                            ...
                            <asp:TableRow ID="CABECERA" runat="server">
                                ...
                                <asp:TableCell ID="_MARCA_MODELO" runat="server" BackColor="Black" BorderColor="Black"
                                    ForeColor="White" >MARCA / MODELO</asp:TableCell>
