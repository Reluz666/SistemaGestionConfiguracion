        ...
        <div class="container">
            ...
            <div class="form-card">
                <div class="card-header">
                    <i class="bi bi-briefcase-fill me-2"></i>Ingrese Datos Profesion / Ocupacion
                </div>
                <div class="card-body p-3">
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        ...
                        <asp:Button ID="btnModificar" runat="server" Text="Modificar" CssClass="btn btn-warning btn-modern"
                                    ...
                                    OnClientClick="return Confirmar('¿Desea modificar Profesion / Ocupacion?');" />
                        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn btn-danger btn-modern"
                                    OnClick="btnEliminar_Click"
                                    OnClientClick="return Confirmar('¿Desea eliminar Profesion / Ocupacion?');" />
            ...
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-list-ul me-2"></i>Listado de Profesiones / Ocupaciones</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tblProfesiones" class="table table-modern table-hover">
                        <thead>
                            <tr>
            ...
            <asp:HiddenField ID="Id_prof_ocup" runat="server" Value="0" EnableViewState="False" />
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function filtrarTabla(texto) {
            ...
            for (var i = 0; i < datosCompletos.length; i++) {
                ...
                var textoFila = (row.NOMBRE || '') + ' ' + (row.DESCRIPCION || '');
        ...
        function renderizarTabla(datos) {
            var tbody = document.getElementById('tbodyProfesiones');
            var sb = '';
            if (datos.length === 0) {
            ...
            for (var i = 0; i < datos.length; i++) {
                ...
                sb += '<a href="ProfecionOcupacion.aspx?Operacion=M&IdProfOcup=' + htmlEncode(row.ID) + '" class="btn btn-primary btn-sm btn-accion me-1">Editar</a>';
                sb += '<a href="ProfecionOcupacion.aspx?Operacion=E&IdProfOcup=' + htmlEncode(row.ID) + '" class="btn btn-danger btn-sm btn-accion" onclick="return confirm(\'¿Esta seguro de eliminar esta profesion/ocupacion?\');">Eliminar</a>';
                sb += '</td>';
                sb += '</tr>';
            }
            tbody.innerHTML = sb;
