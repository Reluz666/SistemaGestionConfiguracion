<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProfecionOcupacion.aspx.cs" Inherits="Usuario" UnobtrusiveValidationMode="None" %>
...
<head runat="server">
    ...
    <title>Profesion / Ocupacion</title>
    ...
    <style>
        ...
        #TableUsuario tbody tr:hover td {
            background: rgba(233, 69, 96, 0.04) !important;
        }

        #TableUsuario tbody tr td {
            padding: 0.5rem 0.45rem !important;
            border: none !important;
    ...
    <div class ="container">
         <div class="table-responsive" >
             <table class="table text-center" >
                <thead>
                  <tr>
                    <td style="text-align: center; color: #FFFFFF; background-color: #000000;" colspan="2"> INGRESE DATOS PROFECION oCUPACION</td>

                  </tr>
                  <tr>
                        <td style="text-align: left; color: #FFFFFF; background-color: #000000;"
                            class="style2"> Profesion / Ocupacion&nbsp;</td>

                        <td style="text-align: left; color: #FFFFFF; background-color: #000000;"
                            class="style2">Descripcion Profesion / Ocupacion</td>
                  ...
                  <tr>
                        <td style="text-align: left" class="style2">
                             <asp:TextBox ID="Prof_Ocup" runat="server" CssClass="form-control input-sm" MaxLength="25" Autocomplete = "off" placeholder="Ingrese Profesion / Ocupacion" onchange="CambiaLetraMayuscula('Prof_Ocup')"
                        onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="rfvProf_Ocup" runat="server" ControlToValidate="Prof_Ocup" ErrorMessage="*" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>

                        <td style="text-align: left" class="style2">
                             <asp:TextBox ID="Descripcion_prof_ocup" runat="server" CssClass="form-control input-sm" MaxLength="25" Autocomplete = "off" placeholder="Ingrese Descripcion Profesion / Ocupacion" onchange="CambiaLetraMayuscula('Descripcion_prof_ocup')"
                        onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                        </td>
                ...
                <td colspan="2" style="text-align: center">
                   <asp:Button ID="btnRegistrar" runat="server"
                       style="font-family: Calibri; color: #000000; font-size: medium"
                        Text="Registrar"
                        onclientclick="return Confirmar('¿Desea registrar Profesion / Ocupacion?');"
                        CssClass="btn btn-success" Visible="False" OnClick="btnRegistrar_Click" />
                    &nbsp;
                    <asp:Button ID="btnModificar" runat="server"
                        style="font-family: Calibri; color: #000000; font-size: medium"
                        Text="Modificar"  onclientclick="return Confirmar('¿Desea modificar Profesion / Ocupacion?');" CssClass="btn btn-warning" Visible="False" OnClick="btnModificar_Click" />
                    &nbsp;
                    <asp:Button ID="btnEliminar" runat="server"
                        style="font-family: Calibri; color: #000000; font-size: medium"
                        Text="Eliminar"  onclientclick="return Confirmar('¿Desea eliminar Profesion / Ocupacion?');" class="btn btn-danger" Visible="False" OnClick="btnEliminar_Click" />
                    &nbsp;
    ...
    <div class ="container">
            ...
            <td colspan="4">
                        ...
                        <asp:Table ID="TableUsuario" runat="server" CssClass="form-control input"
                            ...
                            <asp:TableRow ID="TableRow1" runat="server">
                                <asp:TableCell ID="tcId_prof_ocup"  runat="server" BackColor="Black" BorderColor="Black"
                                    ForeColor="White" Width="7%" Visible="false">ID USU</asp:TableCell>

                                <asp:TableCell ID="tcProf_Ocup"  runat="server" BackColor="Black" BorderColor="Black"
                                    ForeColor="White"  Width="15%">PROFESION / OCUPACION</asp:TableCell>

                                <asp:TableCell ID="tcDescripcion_prof_ocup"  runat="server" BackColor="Black" BorderColor="Black"
                                    ForeColor="White"  Width="15%">DESCRIPCION</asp:TableCell>

                                <asp:TableCell ID="SELECCIONAR_PROFESION_OCUPACION" runat="server" BackColor="Black" BorderColor="Black"
        ...
        <tr>
            <td colspan="3">
                    ...
                    <asp:HiddenField ID="Id_prof_ocup" runat="server" Value="0"
