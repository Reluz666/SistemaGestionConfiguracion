...
public partial class TiposElementoConfiguracion : System.Web.UI.Page
{
                            ...
                            switch (j)
                            {
                                ...
                                case 2:
                                    ...
                                    if (rpta == true)
                                    {
                                        ...
                                        b.Click += new System.EventHandler(visualiza_datos_modelo);
    ...
    private void Matenimiento_Modelo(int _ID_MOD,
        string _NOMBRE,
        string operacion)
    {
        policia.clsaccesodatos servidor = new policia.clsaccesodatos();
        ...
        try
        {
            ...
            {
                servidor.ejecutar("[dbo].[pr_MatenimientoModelo]",
                                    false,
                                    _ID_MOD,
                                    _NOMBRE.Trim(),
                                    operacion,
    ...
    protected void btnRegistrar_Click(object sender, EventArgs e)
    {
        ...
        this.Matenimiento_Modelo(Convert.ToInt32(this.ID_MOD.Value.Trim()),
