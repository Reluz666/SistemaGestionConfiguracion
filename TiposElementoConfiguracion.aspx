<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TiposElementoConfiguracion.aspx.cs" Inherits="TiposElementoConfiguracion" UnobtrusiveValidationMode="None" %>
...
<body onload="MostrarMensaje()">
        ...
        <div class="container">
            ...
            <div class="form-card">
                <div class="card-header">
                    <i class="bi bi-list-ul me-2"></i>Ingrese Datos Tipo Elemento Configuracion
                </div>
                <div class="card-body p-3">
                    <div class="row g-3 mb-3">
                        <div class="col-md-12 col-sm-12">
                            <label class="form-label-modern">Nombre Tipo CI</label>
                            <asp:TextBox ID="NOMBRE_TIPO" runat="server" CssClass="form-control form-control-modern"
                                         MaxLength="25" Autocomplete="off" placeholder="Ingrese Nombre Tipo Elemento Configuracion"
                                         onchange="CambiaLetraMayuscula('NOMBRE_TIPO')"
                                         onkeypress="SoloLetrasMinusculas()" />
                            <asp:RequiredFieldValidator ID="rfvNOMBRE_TIPO" runat="server" ControlToValidate="NOMBRE_TIPO"
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        ...
                        <asp:Button ID="btnModificar" runat="server" Text="Modificar" CssClass="btn btn-warning btn-modern"
                                    OnClientClick="return Confirmar('¿Desea modificar Tipo Elemento Configuracion?');"
                                    OnClick="btnModificar_Click" />
                        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn btn-danger btn-modern"
                                    OnClientClick="return Confirmar('¿Desea eliminar Tipo Elemento Configuracion?');"
            ...
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-list-ul me-2"></i>Listado de Tipos de Elementos de Configuracion</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tblTiposElemento" class="table table-modern table-hover">
                        <thead>
                            <tr>
                                <th>NOMBRE TIPO CI</th>
                                <th>ACCIONES</th>
                            </tr>
                        </thead>
                        <tbody id="tbodyTiposElemento">
                        </tbody>
                    </table>
                </div>
            ...
            <asp:HiddenField ID="ID_TIPO" runat="server" Value="0" EnableViewState="False" />
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function renderizarTabla(datos) {
            var tbody = document.getElementById('tbodyTiposElemento');
            var sb = '';
            if (datos.length === 0) {
            ...
            for (var i = 0; i < datos.length; i++) {
                ...
                sb += '<a href="TiposElementoConfiguracion.aspx?Operacion=M&IDTipo=' + htmlEncode(row.ID) + '" class="btn btn-primary btn-sm btn-accion me-1">Editar</a>';
                sb += '<a href="TiposElementoConfiguracion.aspx?Operacion=E&IDTipo=' + htmlEncode(row.ID) + '" class="btn btn-danger btn-sm btn-accion" onclick="return confirm(\'¿Esta seguro de eliminar este tipo elemento?\');">Eliminar</a>';
                sb += '</td>';
                sb += '</tr>';
            }
            tbody.innerHTML = sb;
