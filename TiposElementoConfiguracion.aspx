    ...
    <div class ="container">
         <div class="table-responsive" >
             <table class="table text-center" >
                <thead>                       
                  <tr>
                    <td style="text-align: center; color: #FFFFFF; background-color: #000000;" colspan="3"> INGRESE DATOS TIPOS ELEMENTO CONFIGURACION</td>
                   
                  </tr>
                  <tr>
                        <td style="text-align: left; color: #FFFFFF; background-color: #000000;" 
                            class="style2" colspan="3"> Nombre Tipo CI</td>
                  ...
                  <tr>
                        <td style="text-align: left;" 
                            class="style2" colspan="3"> 
                             <asp:TextBox ID="NOMBRE_TIPO" runat="server" CssClass="form-control input-sm" Autocomplete = "off" placeholder="Ingrese Nombre Tipo Elemento Configuracion" onchange="CambiaLetraMayuscula('NOMBRE_TIPO')" 
                        onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="rfvNOMBRE_TIPO" runat="server" ControlToValidate="NOMBRE_TIPO" ErrorMessage="*" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
