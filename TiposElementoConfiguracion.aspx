        ...
        <div class="container">
            ...
            <div class="form-card">
                <div class="card-header">
                    <i class="bi bi-list-ul me-2"></i>Ingrese Datos Tipos Elemento Configuracion
                </div>
                <div class="card-body p-3">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <asp:TextBox ID="NOMBRE_TIPO" runat="server" CssClass="form-control form-control-modern" Autocomplete="off" placeholder="Ingrese Nombre Tipo Elemento Configuracion" onchange="CambiaLetraMayuscula('NOMBRE_TIPO')"
                        onkeypress="SoloLetrasMinusculas()"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvNOMBRE_TIPO" runat="server" ControlToValidate="NOMBRE_TIPO" ErrorMessage="*" CssClass="validator-error" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        ...
                        <asp:Button ID="btnModificar" runat="server"
                            style="font-family: Calibri; color: #000000; font-size: medium"
                            Text="Modificar"  onclientclick="return Confirmar('¿Desea modificar Tipo Elemento Configuracion?');" CssClass="btn btn-warning btn-modern" Visible="False" OnClick="btnModificar_Click" />
                        <asp:Button ID="btnEliminar" runat="server"
                            style="font-family: Calibri; color: #000000; font-size: medium"
                            Text="Eliminar"  onclientclick="return Confirmar('¿Desea eliminar Tipo Elemento Configuracion?');" class="btn btn-danger btn-modern" Visible="False" OnClick="btnEliminar_Click" />
            ...
            <div class="table-wrapper">
                <asp:Table ID="Table_" runat="server" CssClass="table table-modern-grid table-hover">
                    <asp:TableRow ID="TableRow1" runat="server">
                        <asp:TableCell ID="tcID_TIPO"  runat="server" BackColor="Black" BorderColor="Black"
                        ...
                        <asp:TableCell ID="tcNOMBRE_TIPO"  runat="server" BackColor="Black" BorderColor="Black"
                            ForeColor="White"  Width="15%">NOMBRE TIPO CI</asp:TableCell>

                        <asp:TableCell ID="SELECCIONAR_TIPO_CI" runat="server" BackColor="Black" BorderColor="Black"
                            ForeColor="White" Width="7%">SELECCIONAR TIPO CI</asp:TableCell>
            ...
            <asp:HiddenField ID="ID_TIPO" runat="server" Value="0"
