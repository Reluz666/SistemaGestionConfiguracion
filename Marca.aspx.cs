...
public partial class TiposElementoConfiguracion : System.Web.UI.Page
{
                        ...
                        for (int j = 0; j < Table_.Rows[i].Cells.Count; j++)//Cabecera de la tabla
                        {
                            ...
                            switch (j)
                            {
                                ...
                                case 2:
                                    ...
                                    {
                                        tCell.Text = "SIN PERMISO PARA SELECCIONAR";
    ...
    private void Matenimiento_Marca(int _ID_MAR,
        string _NOMBRE,
        string operacion)
    {
        policia.clsaccesodatos servidor = new policia.clsaccesodatos();
        ...
        try
        {
            ...
            {
                servidor.ejecutar("[dbo].[pr_MatenimientoMarca]",
                                    false,
                                    _ID_MAR,
                                    _NOMBRE.Trim(),
                                    operacion,
