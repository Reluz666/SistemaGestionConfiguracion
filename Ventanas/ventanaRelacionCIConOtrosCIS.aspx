        ...
        <div class="container py-4">
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-diagram-3 me-2"></i>Relaciones de Elementos de Configuraci&oacute;n</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tblDatos" class="table table-modern table-hover">
                        <thead>
                            <tr>
                                <th style="width:50%">PADRE ELEMENTO CONFIGURACION</th>
                                <th style="width:50%">HIJO ELEMENTO CONFIGURACION</th>
                                <th>TIPO RELACION</th>
                            </tr>
                        </thead>
                        <tbody id="tbodyDatos">
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function filtrarTabla(texto) {
            ...
            for (var i = 0; i < datosCompletos.length; i++) {
                ...
                var textoFila = row['PADRE CI'] + ' ' + row['HIJO CI'] + ' ' + row['TIPO RELACION'];
        ...
        function renderizarTabla(datos) {
            ...
            for (var i = 0; i < datos.length; i++) {
                ...
                sb += '<tr>';
                sb += '<td>' + row['PADRE CEL'] + '</td>';
                sb += '<td>' + row['HIJO CEL'] + '</td>';
                sb += '<td>' + htmlEncode(row['TIPO RELACION']) + '</td>';
                sb += '</tr>';
            }
