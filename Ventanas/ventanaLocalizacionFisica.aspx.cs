                        ...
                        for (int j = 0; j < Table_.Rows[i].Cells.Count; j++)//Cabecera de la tabla
                        {
                            ...
                            switch (j)
                            {
                                ...
                                case 10:
                                    ...
                                    b.OnClientClick = "AREA('" + dt.Rows[i]["ID"].ToString() + "','" + dt.Rows[i]["AREA"].ToString() + "','" + dt.Rows[i]["SEDE"].ToString() + "','" + dt.Rows[i]["LOCAL"].ToString() + "','" + dt.Rows[i]["DISTRITO"].ToString() + " / " + dt.Rows[i]["PROVINCIA"].ToString() + " / " + dt.Rows[i]["DEPARTAMENTO"].ToString() + "','" + dt.Rows[i]["DIRECCION LOCAL"].ToString() + "','" + dt.Rows[i]["NRO PISO"].ToString() + "','" + dt.Rows[i]["NRO AMBIENTE"].ToString() + "');";
