...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script lang="javascript" type="text/javascript">
        function TIPOSELEMTOCONFIGURACION(_ID_TIPO, _TIPO_ELEMENTO_CONFIGURACION) {
        ...
        <div class="container py-4">
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-tags me-2"></i>Tipos de Elemento Configuraci&oacute;n</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tblDatos" class="table table-modern table-hover">
                        <thead>
                            <tr>
                                <th>TIPO ELEMENTO CONFIGURACION</th>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function filtrarTabla(texto) {
            ...
            for (var i = 0; i < datosCompletos.length; i++) {
                ...
                var textoFila = row['TIPO ELEMENTO CONFIGURACION'];
        ...
        function renderizarTabla(datos) {
            ...
            for (var i = 0; i < datos.length; i++) {
                ...
                sb += '<tr>';
                sb += '<td>' + htmlEncode(row['TIPO ELEMENTO CONFIGURACION']) + '</td>';
                sb += '<td class="text-center">';
                sb += '<button type="button" class="btn btn-success btn-sm btn-accion" onclick="TIPOSELEMTOCONFIGURACION(\'' + htmlEncode(row.CODIGO) + '\',\'' + htmlEncode(row['TIPO ELEMENTO CONFIGURACION']) + '\')">Seleccionar</button>';
                sb += '</td>';
                sb += '</tr>';
            }
