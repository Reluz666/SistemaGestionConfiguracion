...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script lang="javascript" type="text/javascript">
        function UBICACION_GEOGRAFICA(_ID, _CODIGO, _DEPARTAMENTO, _PROVINCIA, _DISTRITO) {
        ...
        <div class="container py-4">
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-geo me-2"></i>Ubigeo</h4>
                </div>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function filtrarTabla(texto) {
            ...
            for (var i = 0; i < datosCompletos.length; i++) {
                ...
                var textoFila = row.CODIGO + ' ' + row.DEPARTAMENTO + ' ' + row.PROVINCIA + ' ' + row.DISTRITO;
        ...
        function renderizarTabla(datos) {
            ...
            if (datos.length === 0) {
                tbody.innerHTML = '<tr><td colspan="5" class="text-center text-muted py-4">No se encontraron elementos</td></tr>';
                return;
            }
            ...
            for (var i = 0; i < datos.length; i++) {
                ...
                sb += '<button type="button" class="btn btn-success btn-sm btn-accion" onclick="UBICACION_GEOGRAFICA(\'' + htmlEncode(row.ID) + '\',\'' + htmlEncode(row.CODIGO) + '\',\'' + htmlEncode(row.DEPARTAMENTO) + '\',\'' + htmlEncode(row.PROVINCIA) + '\',\'' + htmlEncode(row.DISTRITO) + '\')">Ubigeo</button>';
                sb += '</td>';
                sb += '</tr>';
            }
