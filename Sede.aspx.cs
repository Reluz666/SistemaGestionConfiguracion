...
public partial class TiposElementoConfiguracion : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        bool rpta = this.VERIFICAR_PERMISO_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]), "Sede.aspx");
        if (rpta == false)
        {
    ...
    private void Lista_Sedes()
    {
        ...
        try
        {
            ...
            if (servidor.abrirconexion() == true)
            {
                dt = servidor.consultar("[dbo].[pr_Lista_Sedes]").Tables[0];
                servidor.cerrarconexion();

                if (dt.Rows.Count == 0)
                {
                    datosJson.Value = "[]";
                    _Lista.ShowMessage(__mensaje, __pagina, "No hay Sedes registradas.", "");
                }
                else
                {
    ...
    protected void visualiza_datos_sede(object sender, EventArgs e)
    {
        this.__mensaje.Value = "";
        this.__pagina.Value = "";
        ...
        this.Id_Sede.Value = Datos[0];
        this.CodIgo_Sede.Text = Datos[1];
        this.Descripcion_Sede.Text = Datos[2];
        this.btnRegistrar.Visible = false;
        this.btnCancelar.Visible = true;
        oculta(true);
    }

    private void Matenimiento_Sede(int _Id_Sede, int _CodIgo_Sede, string _Descripcion_Sede, string operacion)
    {
        policia.clsaccesodatos servidor = new policia.clsaccesodatos();
        servidor.cadenaconexion = Ruta;
        try
        {
            ...
            {
                servidor.ejecutar("[dbo].[pr_MatenimientoSede]", false, _Id_Sede, _CodIgo_Sede, _Descripcion_Sede.Trim(), operacion, 0, "");
                if (servidor.getRespuesta() == 1)
                {
                    servidor.cerrarconexiontrans();
                    ShowMessage(servidor.getMensaje(), "Sede.aspx");
                }
                else
                {
    ...
    protected void btnRegistrar_Click(object sender, EventArgs e)
    {
        ...
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]), "Sede.aspx", "NUEVO");
        if (rpta == false)
        {
        ...
        if (!rfvDescripcion_Sede.IsValid) return;

        this.Matenimiento_Sede(Convert.ToInt32(this.Id_Sede.Value.Trim()),
            Convert.ToInt32(this.CodIgo_Sede.Text.Trim()),
            this.Descripcion_Sede.Text.Trim(), "N");
    }
    ...
    protected void btnModificar_Click(object sender, EventArgs e)
    {
        ...
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]), "Sede.aspx", "MODIFICAR");
        if (rpta == false)
        {
        ...
        this.Matenimiento_Sede(Convert.ToInt32(this.Id_Sede.Value.Trim()),
            Convert.ToInt32(this.CodIgo_Sede.Text.Trim()),
            this.Descripcion_Sede.Text.Trim(), "M");
    }
    ...
    protected void btnEliminar_Click(object sender, EventArgs e)
    {
        ...
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]), "Sede.aspx", "ELIMINAR");
        if (rpta == false)
        {
        ...
        this.Matenimiento_Sede(Convert.ToInt32(this.Id_Sede.Value.Trim()),
            Convert.ToInt32(this.CodIgo_Sede.Text.Trim()),
            this.Descripcion_Sede.Text.Trim(), "E");
    }

    protected void btnCancelar_Click(object sender, EventArgs e)
    {
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]), "Sede.aspx", "CANCELAR");
        if (rpta == false)
        {
        ...
        this.Response.Redirect("Sede.aspx");
    }
