...
public partial class TiposElementoConfiguracion : System.Web.UI.Page
{
                            ...
                            switch (j)
                            {
                                ...
                                case 3:
                                    ...
                                    if (rpta == true)
                                    {
                                        ...
                                        b.Click += new System.EventHandler(visualiza_datos_sede);
    ...
    private void Matenimiento_Sede(int _Id_Sede,
        int _CodIgo_Sede,
        string _Descripcion_Sede,
        string operacion)
    {
        policia.clsaccesodatos servidor = new policia.clsaccesodatos();
        servidor.cadenaconexion = Ruta;
        try
        {
            ...
            {
                servidor.ejecutar("[dbo].[pr_MatenimientoSede]",
                                    false,
                                    _Id_Sede,
                                    _CodIgo_Sede,
                                    _Descripcion_Sede.Trim(),
                                    operacion,
                                    0, "");
    ...
    protected void btnRegistrar_Click(object sender, EventArgs e)
    {
        ...
        Boolean ok;
        ok = rfvDescripcion_Sede.IsValid;
        if (ok == false)
        {
            return;
        }
        ...
        this.Matenimiento_Sede(Convert.ToInt32(this.Id_Sede.Value.Trim()),
            ...
            this.Descripcion_Sede.Text.Trim(),
            "N");
    }
