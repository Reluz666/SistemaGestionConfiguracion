...
public partial class ElementosConfiguracion : System.Web.UI.Page
{
    ...
    private void Elementos_Configuracion_Seguidos(string Nombre_CI, string Tipo_CI, string Nro_Serie, string Descripcion_CI, string Sede, string Local, string Area, string Responsable, string Clasificacion_Datos, string Relacion_otros_CIs, string Fecha_Inicio, string Fecha_Fin, string Estado_Actual_CIs, String Mensaje)
    {
        ...
        try
        {
            ...
            {
                DataTable dt = servidor.consultar("[dbo].[pr_ListaSeguimientoElementosConfiguracion]", Nombre_CI, Tipo_CI, Nro_Serie, Descripcion_CI, Sede, Local, Area, Responsable, Clasificacion_Datos, Relacion_otros_CIs, Fecha_Inicio, Fecha_Fin, Estado_Actual_CIs).Tables[0];
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        for (int j = 0; j < Table_.Rows[i].Cells.Count; j++)//Cabecera de la tabla
                        {
                            ...
                            case 19:
                                    ...
                                    "SeguimientosElementoConfiguracion.aspx", "EDITAR");
    ...
    protected void Page_init(object sender, EventArgs e)
    {
        ...
        // Cargar lista de seguimientos para la seccion de busqueda con paginacion
    ...
    protected void lbtnBuscar_Click(object sender, EventArgs e)
    {
        ...
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]),
        "SeguimientosElementoConfiguracion.aspx", "BUSCAR");
        if (rpta == false)
        {
        ...
        Response.Clear();
        Response.Redirect("SeguimientosElementoConfiguracion.aspx");
        Response.Flush();
    ...
    protected void btnActualizarInformacion_Click(object sender, EventArgs e)
    {
        ...
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]),
        "SeguimientosElementoConfiguracion.aspx", "ACTUALIZAR");
        if (rpta == false)
        {
