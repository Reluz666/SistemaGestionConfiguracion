...
public partial class TiposElementoConfiguracion : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        bool rpta = this.VERIFICAR_PERMISO_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]), "TiposElementoConfiguracion.aspx");
        if (rpta == false)
        {
        ...
        Lista_Tipos_Elementos_Configuracion();
    }
    ...
    private void Lista_Tipos_Elementos_Configuracion()
    {
        ...
        try
        {
            ...
            {
                dt = servidor.consultar("[dbo].[pr_Lista_Tipos_Elementos_Configuracion]").Tables[0];
                servidor.cerrarconexion();

                if (dt.Rows.Count == 0)
                {
                    datosJson.Value = "[]";
                    _Lista.ShowMessage(__mensaje, __pagina, "No hay Tipos de Elementos de Configuracion registrados.", "");
                }
                else
                {
    ...
    protected void visualiza_datos_tipos_elemento_configuracion(object sender, EventArgs e)
    {
        ...
        this.ID_TIPO.Value = Datos[0];
        this.NOMBRE_TIPO.Text = Datos[1];
        this.btnRegistrar.Visible = false;
        this.btnCancelar.Visible = true;
        oculta(true);
    }

    private void Matenimiento_Tipos_Elemento_Configuracion(int _ID_TIPO, string _NOMBRE_TIPO, string operacion)
    {
        policia.clsaccesodatos servidor = new policia.clsaccesodatos();
        servidor.cadenaconexion = Ruta;
        try
        {
            ...
            {
                servidor.ejecutar("[dbo].[pr_MatenimientoTiposElementosConfiguracion]", false, _ID_TIPO, _NOMBRE_TIPO.Trim(), operacion, 0, "");
                if (servidor.getRespuesta() == 1)
                {
                    servidor.cerrarconexiontrans();
                    ShowMessage(servidor.getMensaje(), "TiposElementoConfiguracion.aspx");
                }
                else
                {
    ...
    protected void btnRegistrar_Click(object sender, EventArgs e)
    {
        ...
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]), "TiposElementoConfiguracion.aspx", "NUEVO");
        if (rpta == false)
        {
        ...
        if (!rfvNOMBRE_TIPO.IsValid) return;

        this.Matenimiento_Tipos_Elemento_Configuracion(Convert.ToInt32(this.ID_TIPO.Value.Trim()),
            this.NOMBRE_TIPO.Text.Trim(), "N");
    }
    ...
    protected void btnModificar_Click(object sender, EventArgs e)
    {
        ...
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]), "TiposElementoConfiguracion.aspx", "MODIFICAR");
        if (rpta == false)
        {
    ...
    protected void btnEliminar_Click(object sender, EventArgs e)
    {
        ...
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]), "TiposElementoConfiguracion.aspx", "ELIMINAR");
        if (rpta == false)
        {
        ...
        this.Matenimiento_Tipos_Elemento_Configuracion(Convert.ToInt32(this.ID_TIPO.Value.Trim()),
            this.NOMBRE_TIPO.Text.Trim(), "E");
    }

    protected void btnCancelar_Click(object sender, EventArgs e)
    {
        string[] Datos = (string[])Session["__JSAR__"];
        bool rpta = this.VERIFICAR_PERMISOS_DERECHOS_ACCESO_PAGINA_WEB(Convert.ToInt32(Datos[0]), "TiposElementoConfiguracion.aspx", "CANCELAR");
        if (rpta == false)
        {
        ...
        this.Response.Redirect("TiposElementoConfiguracion.aspx");
    }
