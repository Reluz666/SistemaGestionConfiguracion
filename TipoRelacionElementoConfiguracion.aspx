...
<body onload="MostrarMensaje()">
        ...
        <div class="container">
                ...
                <div class="card-body p-3">
                    <div class="row g-3 mb-3">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <asp:TextBox ID="NOMBRE_TIPO_RELA" runat="server" CssClass="form-control form-control-modern"
                                         MaxLength="25" Autocomplete="off" placeholder="Ingrese Nombre Tipo Relacion"
                                         onchange="CambiaLetraMayuscula('NOMBRE_TIPO_RELA')"
                                         onkeypress="SoloLetrasMinusculas()" />
                            <asp:RequiredFieldValidator ID="rfvNOMBRE_TIPO_RELA" runat="server" ControlToValidate="NOMBRE_TIPO_RELA"
            ...
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="bi bi-list-ul me-2"></i>Listado de Tipos de Relaciones</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tblTiposRelacion" class="table table-modern table-hover">
                        <thead>
                            <tr>
                                <th>NOMBRE TIPO RELACION CI</th>
                                <th>ACCIONES</th>
                            </tr>
                        </thead>
                        <tbody id="tbodyTiposRelacion">
                        </tbody>
                    </table>
                </div>
            ...
            <asp:HiddenField ID="COD_TIPO_RELA" runat="server" Value="0" EnableViewState="False" />
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function renderizarTabla(datos) {
            var tbody = document.getElementById('tbodyTiposRelacion');
            var sb = '';
            if (datos.length === 0) {
            ...
            for (var i = 0; i < datos.length; i++) {
                ...
                sb += '<a href="TipoRelacionElementoConfiguracion.aspx?Operacion=M&CodTipoRel=' + htmlEncode(row.ID) + '" class="btn btn-primary btn-sm btn-accion me-1">Editar</a>';
                sb += '<a href="TipoRelacionElementoConfiguracion.aspx?Operacion=E&CodTipoRel=' + htmlEncode(row.ID) + '" class="btn btn-danger btn-sm btn-accion" onclick="return confirm(\'¿Esta seguro de eliminar este tipo relacion?\');">Eliminar</a>';
                sb += '</td>';
                sb += '</tr>';
            }
            tbody.innerHTML = sb;
